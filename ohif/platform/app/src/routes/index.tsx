  ...
  return (
    <div className="absolute flex h-full w-full items-center justify-center text-white">
      <div className="text-center">
        <h1 className="text-3xl mb-4">OHIF Medical Viewer</h1>
        <p>System is ready for integration.</p>
        <p className="text-gray-500 mt-2">Open an exam from LaudoDigital to view images.</p>
      </div>
    </div>
  );
};
...
const createRoutes = ({
  ...
  const SystemReadyRoute = {
    path: '/',
    children: SystemReady,
  };
  ...
  const allRoutes = [
    ...routes,
    ...(showStudyList ? [WorkListRoute] : [SystemReadyRoute]),
    ...(customRoutes?.routes || []),
    ...bakedInRoutes,
