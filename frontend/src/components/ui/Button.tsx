...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    ...
    secondary: "bg-brand-teal-500 text-white hover:bg-brand-teal-600 focus:ring-brand-teal-500",
    outline: "border border-gray-300 bg-transparent text-gray-700 hover:bg-gray-50 focus:ring-brand-blue-500",
