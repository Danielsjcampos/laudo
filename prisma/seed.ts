...
async function main() {
  ...
  await prisma.clinic.create({
    data: {
      ...
      adminEmail: 'admin@saudeplena.com'
    }
  })
  ...
  await prisma.user.createMany({
    data: [
      { id: 'u1', name: 'Operador Sistema', role: 'admin', email: 'admin@laudodigital.com', password: 'admin' },
      { id: 'u2', name: 'Clínica Saúde Plena', role: 'clinic', email: 'contato@saudeplena.com', password: 'password' },
      { id: 'u3', name: 'Dr. Roberto Martins', role: 'doctor', email: 'roberto.martins@doc.com', password: 'password' },
      { id: 'u4', name: 'Carla Ferreira', role: 'patient', email: 'carla.f@email.com', password: 'password' },
    ]
  })
