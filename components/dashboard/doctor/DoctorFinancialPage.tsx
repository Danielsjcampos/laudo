            ...
            <div className="relative z-10 flex flex-col h-full justify-between">
                <div>
                    <div className="flex justify-between items-start">
                        <span className="text-brand-blue-300 font-black uppercase tracking-[0.2em] text-[10px]">Saldo Total Acumulado</span>
                    ...
                    <div className="mt-4 flex items-baseline">
                        ...
                        <span className="text-6xl font-black tabular-nums tracking-tighter">
                            {(received + toReceive).toLocaleString('pt-BR', { minimumFractionDigits: 2 })}
                        </span>
                    </div>
                </div>
                ...
                <div className="mt-12 grid grid-cols-2 gap-8">
                    <div className="p-4 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-sm">
                        <p className="text-brand-blue-300 text-[9px] font-black uppercase mb-1">Disponível para Saque</p>
                        <p className="text-2xl font-black tabular-nums">R$ {received.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</p>
                    </div>
                    <div className="p-4 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-sm">
                        <p className="text-brand-blue-300 text-[9px] font-black uppercase mb-1">Previsão Futura</p>
